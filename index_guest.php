	...
	function AgeCalculation() {
		...
		if(age >=6 )
		{
			...
			if(age < "18") {
				...
				$("#info").attr("href", "https://www.osservatoriocopernico.org/informative-soci/"); //Cambio l'informativa con quella per minorenni...
			...
			/* Sopra i 18 anni visualizzo informativa per i maggiorenni */
				...
				$("#info").attr("href", "https://www.osservatoriocopernico.org/informative-soci/"); //Cambio l'informativa con quella per maggiorenni...
